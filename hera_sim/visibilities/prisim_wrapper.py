...
class PRISim(VisibilitySimulator):
    ...
    def __init__(self, aux_file_loc='prisim_roi_file.fits', fov_radius=90.0,
        ...
        self._prisim_config = self._convert_uvdata_to_prisim_config(self.uvdata, self.beams[0])
        self._write_config_to_file(self._prisim_config, self.config_filename)
    ...
    def validate(self):
        ...
        assert np.all(self.uvdata.integration_time == self.uvdata.integration_time[0]), "PRISim assumes a single integration time for all times"
