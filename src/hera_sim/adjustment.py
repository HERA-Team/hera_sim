...
def match_antennas(
    ...
    if overwrite_telescope_metadata:
        attrs_to_update += (
            ...
            "location_lat_lon_alt_degrees",
        )
    for attr in attrs_to_update:
        setattr(target_copy.telescope, attr, getattr(reference_metadata.telescope, attr))
    ...
    if use_reference_positions and relabel_antennas:
        ...
        target_copy.telescope.antenna_positions = reference_metadata.telescope.antenna_positions
...
def rephase_to_reference(target, reference=None, ref_times=None, ref_lsts=None):
    ...
    lat = target.telescope.location_lat_lon_alt_degrees[0]
