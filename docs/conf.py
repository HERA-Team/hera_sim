...
latex_documents = [
    (master_doc, 'hera_sim.tex', 'hera\\_sim Documentation',
     'HERA-Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'hera_sim', 'hera_sim Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hera_sim', 'hera_sim Documentation',
     author, 'hera_sim', 'One line description of project.',
     'Miscellaneous'),
]
